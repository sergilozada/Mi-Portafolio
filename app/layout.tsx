...
export const metadata: Metadata = {
  title: "Sergi Lozada — Software Engineer & Tech Lead",
  description:
    "Portfolio inmersivo de Sergi Lozada — Software Engineer / Tech Lead. Experiencias web 3D con Next.js y React Three Fiber.",
  authors: [{ name: "Sergi Lozada" }],
  openGraph: {
    title: "Sergi Lozada — Software Engineer & Tech Lead",
    description:
